...
* @returns {string}
*/
export function vecU64ToFelt(array) {
    let deferred2_0;
    let deferred2_1;
    try {
...
*/
export function vecU64ToInt(array) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(array, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
...
* @returns {number}
*/
export function vecU64ToFloat(array, scale) {
    const ptr0 = passArray8ToWasm0(array, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.vecU64ToFloat(ptr0, len0, scale);
    return ret;
}
...
* @returns {Uint8ClampedArray}
*/
export function floatToVecU64(input, scale) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
